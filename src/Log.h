...
namespace cf
{
	namespace utils{
        ...
        #define LOG() Log::instance()->createLogStream(cf::utils::LogLevel::INFO, __FILE__, __LINE__)
        /// 以指定等级调用单例Log对象.
        #define LOGL(level) Log::instance()->createLogStream(cf::utils::LogLevel::level, __FILE__, __LINE__ )
